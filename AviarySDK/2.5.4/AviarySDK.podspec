Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/AviaryInc/Mobile-Feather-SDK-for-iOS.git", :tag => "2.5.4" }
  s.platform     = :ios, '4.0'
  ...
  s.frameworks = 'CoreGraphics', 'QuartzCore', 'Accelerate', 'StoreKit', 'CoreData', 'OpenGLES', 'CoreText'
